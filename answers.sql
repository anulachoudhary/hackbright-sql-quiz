...
SELECT common_name, price FROM melons WHERE melon_type LIKE 'Watermelon' AND price >5;
...
WHERE region IN ('Northwest', 'Southwest') AND last_name like
'M%';
...
SELECT o.ID, o.STATUS, o.ORDER_TOTAL FROM ORDERS AS o
JOIN CUSTOMERS AS C 
...
FROM melons AS m JOIN order_items AS o
ON m.id = o.melon_id
